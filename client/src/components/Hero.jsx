...
const Hero = () => {
    ...
    return (
        <div className="relative w-full flex flex-col justify-center px-4 sm:px-20 xl:px-32 bg-[url('/gradientBackground.png')] bg-cover bg-no-repeat min-h-screen">
            ...
            <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
                <img src={assets.user_group} alt="user" className='h-8' />Trusted by 10k+ people
            </div>
        </div>
    )
}
